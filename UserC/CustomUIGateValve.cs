...
namespace UserC
{
    public partial class CustomUIGateValve : UserControl
    {
        ...
        public CustomUIGateValve()
        {
            InitializeComponent();
            InitializeComponent1();
        }

        private void CustomUIGataValve_Load(object sender, EventArgs e)
        {
