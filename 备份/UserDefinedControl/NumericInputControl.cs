...
namespace UserDefinedControl
{
    ...
    public partial class NumericInputControl : UserControl
    {
        ...
        private void DrawThreeRegions(Graphics g)
        {
            ...
            {
                GraphicsPath path = GetRoundedRectanglePath(controlGroupRect, 6);
            ...
            {
                // 只绘制左侧圆角
                GraphicsPath path = GetLeftRoundedRectanglePath(minusRect, 5);
                g.FillPath(brush, path);
            }
            ...
            {
                // 只绘制右侧圆角
                GraphicsPath path = GetRightRoundedRectanglePath(plusRect, 5);
                g.FillPath(brush, path);
            }
